...
# -*- coding: utf-8 -*-
"""
Created on Fri Feb 11 10:06:36 2022
...
if __name__ == "__main__":
    PATH = "/home/UR/mulapket/Bureau/HPC"
    file = os.path.join(PATH, "jdv_1000.grid")
    grid = read_grid(file)
    # je test avec une plus petite grille pour avoir une vue plus correcte
    # du traitement
    grille = init_grid(6)
    grille = evolution_store(grille)
    #
    print(grille)
    print(statalive(grille))
    print(gamelife(grille,2))
    #
